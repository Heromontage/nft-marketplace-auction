export const NFT_COLLECTION_ADDRESS = "YOUR_DEPLOYED_NFT_ADDRESS";
export const MARKETPLACE_ADDRESS = "YOUR_DEPLOYED_MARKETPLACE_ADDRESS";
export const AUCTION_ADDRESS = "YOUR_DEPLOYED_AUCTION_ADDRESS";
